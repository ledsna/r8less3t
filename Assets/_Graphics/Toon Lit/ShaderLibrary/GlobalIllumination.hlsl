...
half3 GlossyEnvironmentReflection(half3 reflectVector, float3 positionWS, half perceptualRoughness, half occlusion, float2 normalizedScreenSpaceUV)
{
    ...
    // SSR Integration: Sample raw (resolved) texture without mips
    // half ssrMip = PerceptualRoughnessToMipmapLevel(perceptualRoughness); // No Mips
    ...
    half3 normalWS, half3 viewDirectionWS, float2 normalizedScreenSpaceUV)
{
    ...
    // color = EnvironmentBRDFSpecular(brdfData, fresnelTerm);
